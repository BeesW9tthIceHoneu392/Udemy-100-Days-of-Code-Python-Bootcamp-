...
class FlightSearch(FlightData):
    ...
    def __init__(self):
        ...
        self.nextday= self.today + timedelta(1)
        self.six_months = self.tomorrow + timedelta(days=180)
        self.tomorrow_formatted_correctly = self.get_flight_date_range()["tomorrow"]
        self.six_months_formatted_correctly = self.get_flight_date_range()["six_months"]
    ...
    def search_iata_code(self, sheets):
        """
